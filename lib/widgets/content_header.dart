...
class __ContentHeaderDesktopState extends State<_ContentHeaderDesktop> {
  ...
  void initState() { 
    super.initState();
    _videoController = VideoPlayerController.network(widget.featuredContent.videoUrl)..initialize().then((_) => setState((){}))..setVolume(0)..play();
  }
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Stack(
        ...
        children:[
          AspectRatio(
            aspectRatio: _videoController.value.initialized ? _videoController.value.aspectRatio : 2.344,
